...
package com.mytechia.robobo.framework.exception;
 ...
 */
public class ModuleNotFoundException extends InternalErrorException {


    public ModuleNotFoundException(String moduleClass) {
        super("The module '"+moduleClass+"' is no available.");
    }
